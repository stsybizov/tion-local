...
CONF_MAC = "mac"
PLATFORMS = [Platform.SENSOR, Platform.CLIMATE, Platform.SELECT, Platform.FAN, Platform.SWITCH,
             Platform.BINARY_SENSOR, Platform.BUTTON, Platform.NUMBER]
...
TION_SCHEMA = {
    ...
    CONF_KEEP_ALIVE: {'type': int, 'default': 90, 'required': False},
